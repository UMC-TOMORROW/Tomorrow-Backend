...
//                .build();
//
//        Job mockJob = Job.builder().id(jobId).build();
//
...
//        when(reviewRepository.findByJobId(jobId)).thenReturn(List.of(review1, review2));
//
//        // when
...
//                () -> reviewService.getReviewsByJobId(10L, 1L));
//    }
//
//    @Test
...
//                () -> reviewService.getReviewsByJobId(jobId, userId));
//
